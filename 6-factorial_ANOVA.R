...
addon = t.test(socialvalue.wide$'Add-on' ~ Phone, data=socialvalue.wide) # iPhone vs. Android with addon
builtin = t.test(socialvalue.wide$'Built-in' ~ Phone, data=socialvalue.wide) # iPhone vs. Androin builtin
p.adjust(c(addon$p.value, builtin$p.value), method="holm")

# just curious: also compare iPhone 'sit' and 'walk'
iphone = t.test(socialvalue.wide[socialvalue.wide$Phone == "iPhone",]$'Add-on', socialvalue.wide[socialvalue.wide$Phone == "iPhone",]$'Built-in', paired=TRUE)
boxplot(socialvalue.wide[socialvalue.wide$Phone == "iPhone",]$'Add-on', socialvalue.wide[socialvalue.wide$Phone == "iPhone",]$'Built-in',xlab="iPhone.Add-on vs. iPhone.Built-in", ylab="Words") # custom boxplot

android = t.test(socialvalue.wide[socialvalue.wide$Phone == "Android",]$'Add-on', socialvalue.wide[socialvalue.wide$Phone == "Android",]$'Built-in', paired=TRUE)
boxplot(socialvalue.wide[socialvalue.wide$Phone == "Android",]$'Add-on', socialvalue.wide[socialvalue.wide$Phone == "Android",]$'Built-in',xlab="Android.Add-on vs. Android.Built-in", ylab="Words") # custom boxplot
